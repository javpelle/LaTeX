...
\newtheorem{teor}{Teorema}[section] % Estilo de texto cursivo

\theoremstyle{definition} % Cambio del estilo de los teoremas a normal
\newtheorem{proposicion}[teor]{\textbf{Proposici\'on}}
\newtheorem{defi}[teor]{\textbf{Definición}}
\newtheorem{corolario}[teor]{Corolario}
\newtheorem{figura}[teor]{Figura}
...
\newcommand{\normbi}[1]{{\left|\left|#1\right|\right|}_B}
