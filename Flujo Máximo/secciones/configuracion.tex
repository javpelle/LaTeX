...
\newtheorem{proposicion}{\textbf{Proposici\'on}}[section]
\newtheorem{defi}{\textbf{Definición}}[section]
\newtheorem{corolario}{Corolario}[section]
\newtheorem{figura}{Figura}[section]
\newtheorem*{lema}{Lema}
...
\newcommand\DoubleLine[7][4pt]{%
    ...
    \draw[#4]($(h1)!#1!90:(h2)$)-- node [auto=left] [color=black]{#5} ($(h2)!#1!-90:(h1)$); 
    \draw[#6]($(h1)!#1!-90:(h2)$)-- node [auto=right] [color=black]{#7} ($(h2)!#1!90:(h1)$);
}
