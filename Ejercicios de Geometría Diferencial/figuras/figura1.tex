\begin{center}
  ...
  \node[anchor=south] at (T)  {$(\pi r, 2 r )$} ;
  \draw[fill=black] (T) circle (1pt);

  % equations
  \coordinate (E) at ( 4,2.9);
  \node[] at (E) {\scriptsize $P=\alpha(t)=(r(t - \sin t),r(1 - \cos t))$};

  % label 2pi a
  \coordinate (TPA) at (2*pi, 0);
  \node[anchor=north] at (TPA) {$2 \pi r$};
